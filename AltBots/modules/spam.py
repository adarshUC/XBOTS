    ...
    if event.sender_id in SUDO_USERS:
        ...
        try:
            if len(altron) == 3:
                ...
                await event.reply(f"💀 ᴜsᴀɢᴇ:\n  » {hl}spam 10 XD\n  » {hl}spam 10 <ʀᴇᴘʟʏ ᴛᴏ ᴛᴇxᴛ>\n\nᴛᴏ ᴅᴏ sᴘᴀᴍ, ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴜsᴇʀ:\n  » {hl}spam 10 XD <ʀᴇᴘʟʏ ᴛᴏ ᴜꜱᴇʀ>")
...
if event.chat_id in GROUP:
            ...
            try:
                ...
                await event.reply(f"🔞 ᴜsᴀɢᴇ:  {hl}pspam 10")
            except Exception as e:
                print(e)
